...
Every shipped asset must be listed here before release.

Runtime asset downloads are forbidden during gameplay. Assets must be local, licensed, and reviewable.
...
- CC0
- Public Domain
- Explicitly licensed original work

Any other source requires review before use.
...
| yggdrasil-generated-bgm | frontend/src/assets/audio/\*.wav                 | Audio      | Explicitly licensed original work | Project-owned original | OpenAI Codex generated tones | No                   | Title, area, interior, battle BGM | Approved      |

---

## 5. FINAL RULE

If an asset is not listed here, it is not approved for release.
